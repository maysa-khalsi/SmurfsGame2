...
{
    public partial class GrandSchtroumpfControl : UserControl
    {
        ...
        private void LoadImages()
        {
            ...
            _imgRight = LoadSafe(Path.Combine(resDir, "GrandSmurfRight.png"));
            _imgLeft = LoadSafe(Path.Combine(resDir, "GrandSmurfLeft.png"));
            _imgUp = LoadSafe(Path.Combine(resDir, "GrandSmurfUp.png"));
            _imgDown = LoadSafe(Path.Combine(resDir, "GrandSmurfDown.png"));
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            else
            {
                ...
                using (var brush = new SolidBrush(Color.FromArgb(150, 120, 80)))
